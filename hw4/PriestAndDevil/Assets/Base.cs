    ...
    */
    public class ShoreControl
    {
        ...
        public ShoreControl(string type)
        {
            ...
            if (type == "From")
            {
                Shore = (GameObject)Object.Instantiate(Resources.Load("Prefabs/Coast", typeof(GameObject)), from, Quaternion.identity, null);
                Shore.name = "From";
                status = 1;
            }
            else
            {
                Shore = (GameObject)Object.Instantiate(Resources.Load("Prefabs/Coast", typeof(GameObject)), to, Quaternion.identity, null);
                Shore.name = "To";
                status = -1;
            }
        }
